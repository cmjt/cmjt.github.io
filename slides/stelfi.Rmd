...
`r fontawesome::fa("github")` [stelfi](https://github.com/cmjt/stelfi)
...
```{r, eval = TRUE, echo = FALSE, fig.align='center', warning=FALSE, message=FALSE, out.width="80%"}
plot(domain)
points(locs, pch = 20)
```
...
```{r, echo = FALSE, fig.align='center', warning=FALSE, message=FALSE, out.width="60%", out.height="50%"}
data(marked, package = "stelfi")
loc.d <- 3 * cbind(c(0, 1, 1, 0, 0), c(0, 0, 1, 1, 0))
domain <- sp::SpatialPolygons(list(sp::Polygons(list(sp::Polygon(loc.d)),'0')))
require(ggplot2)
ggplot(marked, aes(x = x, y = y, col = m1)) +
  geom_point(size = 5) + scale_color_continuous(type = "viridis") +
  theme_void() + geom_path(data = as.data.frame(loc.d), aes(x = V1, y = V2), inherit.aes = FALSE) +
...
knitr::include_graphics("./img/kai.png")
```
...
.pull-right[
.center[`r fontawesome::fa("circle-question")` @TiagoMarques, Session 39, 1st July]
.center[`r fontawesome::fa("twitter")` @cmjonestodd]
.center[`r fontawesome::fa("github")` [`stelfi`](https://github.com/cmjt/stelfi)]
...
knitr::include_graphics("https://www.royalsociety.org.nz/assets/Uploads/Marsden-logo-RGB-300.jpg")
```
```{r, echo = FALSE, eval = TRUE, out.width="20%", fig.align='center'}
knitr::include_graphics("https://community.apan.org/resized-image/__size/320x240/__key/communityserver-wikis-components-files/00-00-00-17-10/AOARD-Logo_5F00_transp.png")
```
]
