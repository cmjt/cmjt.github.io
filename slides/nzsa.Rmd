...
### `r emo::ji("raised hand")` if you use a `r emo::ji("running")` App
...
.center[
```{r track,eval = TRUE, echo = FALSE,out.height=400}
...
<hr>
.center[<i class="fas fa-images"></i> [cmjt.github.io/slides/nzsa](https://cmjt.github.io/slides/nzsa)]
]